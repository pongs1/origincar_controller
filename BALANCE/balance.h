/*
 * @Date: 2024-05-29 23:48:22
 * @LastEditTime: 2024-05-29 23:57:23
 * @Objc:
 */
#ifndef __BALANCE_H
#define __BALANCE_H
...
///
//自己加的宏
#define TARGET_LIMIT_FLOAT(insert, low, high) \
    ((insert) < (low) ? (low) : ((insert) > (high) ? (high) : (insert)))
#define amplitude 3.5
///
