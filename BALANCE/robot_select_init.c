/*
 * @Date: 2024-05-23 10:34:04
 * @LastEditTime: 2024-05-23 10:35:10
 * @Objc:
 */
...
void Robot_Select(void)
{
	...
	case Akm_Car:
		...
		break; // 阿克曼小车
	case Diff_Car:
		Robot_Init(Diff_wheelSpacing, 0, 0, HALL_30F, Hall_13, Black_WheelDiameter);
		break; // 两轮差速小车
	// case FourWheel_Car:
	// 	Robot_Init(Four_Mortor_wheelSpacing, Four_Mortor__axlespacing, 0, HALL_30F, Hall_13, Black_WheelDiameter);
	// 	break; // 四驱车
	// case Tank_Car:
	// 	Robot_Init(Tank_wheelSpacing, 0, 0, HALL_30F, Hall_13, Tank_WheelDiameter);
	// 	break; // 履带车
	}

	// Check the parameters//自检相关参数
	CheckPhrase1 = 4, CheckPhrase2 = 7;
	// switch (Car_Mode)
	// {
	// case Mec_Car:
	// 	CheckPhrase1 = 8, CheckPhrase2 = 14;
	// 	break; // 麦克纳姆轮小车
	// case Omni_Car:
	// 	CheckPhrase1 = 6, CheckPhrase2 = 10;
	// 	break; // 全向轮小车
	// case Akm_Car:
	// 	CheckPhrase1 = 4, CheckPhrase2 = 7;
	// 	break; // 阿克曼小车
	...
	// 	break; // 两轮差速小车
	// case FourWheel_Car:
	// 	CheckPhrase1 = 8, CheckPhrase2 = 11;
	// 	break; // 四驱车
	// case Tank_Car:
	// 	CheckPhrase1 = 4, CheckPhrase2 = 7;
	// 	break; // 履带车
